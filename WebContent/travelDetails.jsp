...
<body>
				...
				<nav class="navbar navbar-md">
					<div class="navbar-brand text-dark">
						<a href="index.jsp" class="text-decoration-none text-dark"><i
							class="fas fa-user-cog"></i>FlyAway</a>
					</div>
					<ul class="nav">
						<li class="nav-item"><a class="nav-link text-dark" href="loginPage.jsp"><i
								class="fas fa-plane"></i> Admin Login</a></li>
					</ul>
				</nav>
			</div>
			<div class="col-md-12">
	...
	<div class="row align-items-center" style="width: 100%;">
		<div class="col-md-2 bg-secondary booking">
			<form name="contact-form" action="SearchController" method = "get">
				<div class="mb-3">
				...
				<div class="mb-3">
					...
					out.println("<select class=\"form-select\" name=\"source\" required>");
					out.println("<option selected>Select Source</option>");
					while(sourceIterator.hasNext()) {
							Place source = sourceIterator.next();
			

						out.println("<option value =\""+source.getCity()+"\">"+source.getCity()+"</option>");
				...
				<div class="mb-3">
					...
					List<Place> listOfDestination= ps.allPlaceList();
					Iterator<Place> destinationIterator = listOfDestination.iterator();
					out.println("<select class=\"form-select\" name=\"destination\" required>");
					out.println("<option selected>Select Destination</option>");
					while(destinationIterator.hasNext()) {
							Place destination = destinationIterator.next();
			

						out.println("<option value =\""+destination.getCity()+"\">"+destination.getCity()+"</option>");
				...
				<input type="submit" class="btn btn-primary mb-3 text-light" value="Search Flights">
			</form>
		</div>
		<div class="col-md-4">
			<img src="./assets/travel.png"  width="500" height="500" style="float: right">
		</div>
	</div>
</body>
