...
<body>
					...
					<% 	List<Flight> flights = (List<Flight>) session.getAttribute("flights"); 
						for(Flight flight : flights){
							session.setAttribute("price", (int)Math.round(flight.getPrice()));
							session.setAttribute("flightNumber", flight.getFlightName());
							session.setAttribute("airline", flight.getFairlineId());
						}
						Integer n = Integer.parseInt((String)session.getAttribute("travellers"));
						Integer p = Integer.parseInt(session.getAttribute("price").toString());
						Integer total = n*p;
	...
	<div class="row align-items-center" style="width: 100%;">
		<div class="col-md-2 booking d-flex flex-column">
			...
			<div class="col-md-12 bg-secondary" style="width: 100%;">
				...
				<form name="contact-form" action="CardController" method="get">
					<div class="mb-3">
		...
		<div class="col-md-4">
			<img src="./assets/card.png" alt="journey"width="500" height="500" style="float: right">
		</div>
	</div>
</body>
