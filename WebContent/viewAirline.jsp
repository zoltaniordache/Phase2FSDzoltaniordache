		...
		<div class="row g-2">
			<div class="col-md-12 d-flex justify-content-center m-2">
 				<button type="button" class="btn btn-primary" data-bs-toggle="modal" 
 					data-bs-target="#flight">Add Airline</button> -->
		...
		<div class="container">
			<div class="row text-dark">
				<div class="col-md-12 mb-3">
					<p class="lead text-center m-3">Airline Table Data</p>
...
<!-- 	Add Flight Modal -->
	<div class="modal fade" id="flight" tabindex="-1">
		<div class="modal-dialog text-dark">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="enrollLabel">Add Airline</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal"
						aria-label="Close"></button>
				</div>
				<div class="modal-body">
					<form action="AirlineController" method="POST">
						...
						<div class="mb-3">
							<label for="airline" class="col-form-label">Airline Name:</label> 
							<input
								type="text" class="form-control" id="airlineName" name="airlineName"
								required>
